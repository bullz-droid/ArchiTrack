    ...
    <div className="min-h-screen flex items-center justify-center bg-archi-gray/30 px-4">
      <div className="max-w-md w-full bg-white p-12 border border-gray-100 shadow-sm">
        <div className="mb-12 text-center">
          ...
          <p className="text-xs uppercase tracking-widest text-gray-400">Design Studio Manager</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            New to ArchiTrack?{' '}
            <Link to="/register" className="text-archi-black font-bold hover:underline">
              Create an account
            </Link>
          </p>
        </div>
